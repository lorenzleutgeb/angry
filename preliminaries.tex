...
\begin{enumerate}
\item the order of program rules does not matter, and
...
Different techniques have been developed during these years; DLV \cite{dlv}, Smodels \cite{smodels}, Platypus \cite{platypus} and clasp \cite{clasp} are example of solvers. For a more detailed explanation, refer to~\cite{primer}.
